<footer class="m-4 rounded-lg bg-white shadow">
    ...
    <div class="mx-auto w-full max-w-xl p-4 md:flex md:items-center md:justify-between">
        <span class="text-sm text-black dark:text-black sm:text-center mb-4">© 2023 Shunsuke Sakai. All Rights Reserved.</span>
